...
public class ModuleElement extends GuiElement {
    ...
    public void onRender(GuiGraphicsExtractor context, int mouseX, int mouseY) {
        ...
        if (!blacklisted && isHovered(mouseX, mouseY) && hasParent() && mc.gui.screen() instanceof GuiScreen screen && screen.hovered == getParent()) {
    ...
    public void mouseClicked(double mouseX, double mouseY, int button) {
        ...
        else if (button == 1 && mc.gui.screen() instanceof OverviewScreen screen) {
